...
const ABI = require('../artifacts/contracts/BIKES.sol/BIKES.json');
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("BIKES");
  const nft = await NFT.attach('0x56a51b63373d169254ABbe1a2d984745FE4fd17B');
  ...
  console.log("SuperBikesNFT wallet balance", wallet.address, "is: ", balance.toString());
}
